...
<div class="erp-card text-center">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
                                ...
                                <span class="text-success"><?= htmlspecialchars($_SESSION['user']['name'] ?? 'Host') ?></span>
      </div>
      <div class="col-12">
      ...
      <div class="col-md-6">
                                ...
                                <span class="text-primary"><?= date('d M Y, h:i A', strtotime($appointment['appointment_time'])) ?></span>
      </div>
      <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <span class="text-success fw-bold"><?= htmlspecialchars($appointment['pass_number']) ?></span>
    </div>
                            <div class="col-md-6">
